...
import { Shield, Menu, X, Moon, Sun, LogOut, FileText, Clock, Newspaper, Users } from 'lucide-react';
...
export default function Header({ isDark, setIsDark }) {
  ...
  const navItems = [
    { name: 'Mes candidatures', path: '/', icon: FileText },
    { name: 'Relances 1', path: '/relances1', icon: Clock },
    { name: 'Relances 2', path: '/relances2', icon: Clock },
  ];
